...
from expenses.views import home, listing, new_transaction, update, delete, create_new_client, create_new_product, create_new_invoice
...
urlpatterns = [
    ...
    path('Create invoice', create_new_invoice, name= 'url_create_invoice')
